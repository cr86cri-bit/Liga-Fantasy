  ...
  return (
    <div className="app">
      ...
      <nav className="tabs">
        ...
        <button className={tab === "moves" ? "active" : ""} onClick={() => setTab("moves")}>Movimientos<span>{myBids.length + mySales.length}</span></button>
        ...
        <button className={tab === "protection" ? "active" : ""} onClick={() => setTab("protection")}>
          Protección
          <span className={data?.system?.rateLimited ? "tab-status-danger" : "tab-status-safe"}>
            {data?.system?.rateLimited ? "!" : "✓"}
          </span>
        </button>
      </nav>
      ...
      {tab === "market" && (
        <main>
          <SectionHeader
            ...
            description="Solo aparecen jugadores disponibles para una nueva puja. Los jugadores por los que ya pujaste y tus ventas están en la pestaña Movimientos."
          >
      ...
      {tab === "protection" && (
        <main>
          <SectionHeader
            ...
            description="Aquí puedes controlar las peticiones reales, la caché, la cola y los tiempos de actualización sin ocupar espacio en las demás vistas."
          />
          ...
          <section className="protection-info-grid">
            <article>
              <span>🧠</span>
              <div>
                <strong>Caché por módulos</strong>
                <p>
            ...
            <article>
              <span>🪟</span>
              <div>
                <strong>Una pestaña líder</strong>
                <p>
